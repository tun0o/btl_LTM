...
import client.loginGUI.src.swing.Button;
import client.loginGUI.src.swing.MyPasswordField;
import client.loginGUI.src.swing.MyTextField;
...
private Client client;
    public PanelLoginAndRegister(Client client) {
this.client=client;
        initComponents();
        initRegister();
        initLogin();
        ...
        cmd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (client != null) {
                    ...
                    client.sendLogin(username, password); // Gọi trực tiếp sendLogin từ client
                } else {
                    System.out.println("Client chưa được khởi tạo!");
                }
            }
